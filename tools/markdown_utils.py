...
<span class="highlighted-text" style='color:rgb(107, 100, 239)'>PestScope</span>
...
title = "PestScope : Fine-Grained Pest Reasoning Segmentation Model"

description = """
**Usage** : <br>
&ensp;(1) For **Pest Reasoning Segmentation**, input prompt like: *"Can you segment the target pest in this image and provide the pest name?"* <br>
&ensp;(2) For **Target Pest Segmentation**, input prompt like: *"Can you please segment xxx in the given image"* <br>
...
&ensp;(4) For **Agricultural VQA**, input prompt like: *"Could you please identify and describe the pest in the image?"* <br>
&ensp;(5) During training, PestScope uses [SEG] for target pest masks and [NON] for non-target pest suppression. <br>
"""

article = """
<center> PestScope supports fine-grained pest reasoning segmentation for agricultural visual question answering. \n </center>
"""
