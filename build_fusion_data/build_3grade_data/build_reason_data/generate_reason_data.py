...
DEFAULT_OUTPUT_ROOT = str(SCRIPT_DIR / "generated_reason_data")
...
def apply_shadow(image: np.ndarray, mask: np.ndarray, shadow_intensity: float = 0.5) -> np.ndarray:
    import cv2
    import numpy as np
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Generate reason data for simple, medium, or hard difficulty.")
